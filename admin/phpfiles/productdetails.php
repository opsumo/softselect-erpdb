...
if (!empty($product_id)) {
	$sql = "select product_name, vendor_id, review_date, www, notes, mtco from product where product_id = ".$product_id;
...
<table style="font-size:8pt;" width="800px" border="0" cellpadding="2" cellspacing="2">
    ...
    <tr>
        <td colspan="2">Product Specific URL (overrides Vendor URL): <input type="text" size="100" name="www" id="www" value="<?php echo $www;?>" /><hr /></td>
    </tr>
	<tr>
		<td valign="top">
			<!--Cost range table-->
