...
class PS_Pagination {
	...
	function renderFullNav() {
		return "<table width='100%' align='center'><tr><td width='5%' align='center'>".$this->renderFirst() ."</td><td width='5%'  align='center'>". $this->renderPrev() ."</td><td width='80%' align='center'><center>". $this->renderNav() ."</center></td><td width='5%' align='center'>". $this->renderNext() ."</td><td width='5%' align='center'>". $this->renderLast()."</td></tr></table>";
	}
